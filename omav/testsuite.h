...
static void mavlink_test_dynamixel_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_dynamixel_status_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.angles, packet_in.angles, sizeof(float)*8);
    ...
    mavlink_msg_dynamixel_status_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_dynamixel_status_pack(system_id, component_id, &msg , packet1.time_boot_us , packet1.noutputs , packet1.angles );
    mavlink_msg_dynamixel_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_dynamixel_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_us , packet1.noutputs , packet1.angles );
    mavlink_msg_dynamixel_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_dynamixel_status_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_dynamixel_status_send(MAVLINK_COMM_1 , packet1.time_boot_us , packet1.noutputs , packet1.angles );
    mavlink_msg_dynamixel_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
